...
class Workout {
    ...
    _setDescription() {
        ...
        this.discription = `${this.type[0].toUpperCase()}
...
class App {
    ...
    _newWorkOut(e) {
        ...
        // Check if data os valid

        // if workout runnnig, cfreate running object
        if (type === 'running') {
        ...
        // if workout cycling, cfreate cycling object
        if (type === 'cycling') {
