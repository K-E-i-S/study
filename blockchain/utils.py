...
def sorted_dict_by_key(unsortted_dict):
    return collections.OrderedDict(
        sorted(unsortted_dict.items(), key=lambda d:d[0]))
...
def get_host():
    try:
        ...
        logger.debug({'action': 'get_hsot', 'ex': ex})
    return '127.0.0.1'

if __name__ == '__main__':
    # print(is_found_host('127.0.0.1', 5000))
    # print(find_neighbours('192.168.43.86', 5000, 0, 3, 5000, 5003))
    print(get_host())